...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NOMBRE = "CNE_CFLM";
    public static final String TABLA_NOMBRE = "VOTANTES_CFLM";
    public static final String Col_1 = "ID";
    public static final String Col_2 = "NOMBRE_CFLM";
    public static final String Col_3 = "APELLIDO_CFLM";
    public static final String Col_4 = "RECINTO_ELECTORAL_CFLM";
    public static final String Col_5 = "AÑO_DE_NACIMIENTO_CFLM";
