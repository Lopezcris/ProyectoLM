package com.facci.proyectocflm;
...
public class MainActivityCFML extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_cfml);
    ...
    public void InsetarClick(View v) {
        ...
        if (Guardadatos) {
            Toast.makeText(MainActivityCFML.this, "Datos Ingresados", Toast.LENGTH_SHORT).show();
        }else{Toast.makeText(MainActivityCFML.this,"Ocurrio un error datos no ingresados",Toast.LENGTH_SHORT).show();}
    }
    ...
    public void ModificarClick (View v) {
        ...
        if(ModificandoDatos)
            Toast.makeText(MainActivityCFML.this,"Datos Modificados",Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(MainActivityCFML.this,"Lo sentimos ocurrió un error",Toast.LENGTH_SHORT).show();
    ...
    public void EliminarClick (View v) {
        ...
        if(registrosEliminados > 0 ){
            Toast.makeText(MainActivityCFML.this,"Registro(s) Eliminado(s)",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(MainActivityCFML.this,"ERROR: Registro no eliminado",Toast.LENGTH_SHORT).show();
        }
    }
}
